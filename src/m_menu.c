...
static void M_MultiplayerDisabled(INT32 choice);
...
#ifndef NONET
	{IT_STRING|IT_CALL, NULL, "Multiplayer", M_MultiplayerDisabled,      84}, // No multiplayer atm, would probably crash.
#else
	{IT_STRING|IT_CALL,    NULL, "Multiplayer", M_MultiplayerDisabled,   84},
#endif
...
static void M_MultiplayerDisabled(INT32 choice)
{
	...
	M_StartMessage(M_GetText("Multiplayer is currently disabled.\n"),M_ClearMenus,MM_NOTHING);
}
